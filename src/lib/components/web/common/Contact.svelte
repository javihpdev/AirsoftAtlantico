...
<div class="relative flex flex-col md:flex-row p-10 justify-center gap-5 w-full max-w-full bg-cover bg-center md:bg-[center_bottom_0px]" style="background-image: url('src/lib/components/web/images/_14A1029.avif'); loading: eager;">
